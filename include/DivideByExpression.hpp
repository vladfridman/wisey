...
#ifndef DivideByExpression_h
#define DivideByExpression_h
...
namespace wisey {
   ...
   */
  class DivideByExpression : public IBinaryExpression {
  ...
  public:
    ...
    DivideByExpression(const IExpression* expression, const IExpression* adjustment, int line);
