...
TEST_F(ThrowReferenceCountExceptionFunctionTest, getTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  %2 = getelementptr %wisey.lang.MReferenceCountException, %wisey.lang.MReferenceCountException* %1, i32 0, i32 2"
  ...
  "\n  call void @destructor.wisey.lang.MReferenceCountException(i8* %15)"
  "\n  resume { i8*, i32 } %13"
  "\n"
  "\ninvoke.continue:                                  ; preds = %entry"
  "\n  unreachable"
