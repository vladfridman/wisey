...
TEST_F(ThrowReferenceCountExceptionFunctionTest, getTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  call void @llvm.memset.p0i8.i64(i8* %1, i8 0, i64 ptrtoint (%wisey.lang.MReferenceCountException.refCounter* getelementptr (%wisey.lang.MReferenceCountException.refCounter, %wisey.lang.MReferenceCountException.refCounter* null, i32 1) to i64), i32 4, i1 false)"
  ...
  "\n  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %22, i8* %21, i64 add (i64 ptrtoint (%wisey.lang.MReferenceCountException* getelementptr (%wisey.lang.MReferenceCountException, %wisey.lang.MReferenceCountException* null, i32 1) to i64), i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64)), i32 4, i1 false)"
