...
TEST_F(ThrowReferenceCountExceptionFunctionTest, getTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  %5 = getelementptr %wisey.lang.MReferenceCountException, "
  "%wisey.lang.MReferenceCountException* null, i32 1"
  "\n  %6 = ptrtoint %wisey.lang.MReferenceCountException* %5 to i64"
  ...
  "\n  %8 = landingpad { i8*, i32 }"
  "\n          cleanup"
  "\n  %9 = load %wisey.lang.MReferenceCountException*, "
  "%wisey.lang.MReferenceCountException** %2"
  "\n  call void @destructor.wisey.lang.MReferenceCountException("
  "%wisey.lang.MReferenceCountException* %9)"
  "\n  resume { i8*, i32 } %8"
  "\n"
  "\ninvoke.continue:                                  ; preds = %entry"
  "\n  unreachable"
