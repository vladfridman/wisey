...
TEST_F(CheckCastToObjectFunctionTest, getTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %14, i8* %13, i64 add (i64 mul nuw (i64 ptrtoint (i1** getelementptr (i1*, i1** null, i32 1) to i64), i64 3), i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64)), i32 4, i1 false)"
