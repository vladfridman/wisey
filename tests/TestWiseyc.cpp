...
TEST_F(MainTest, extractHeadersTest) {
  ...
  EXPECT_STREQ("/* Interfaces */\n"
              ...
              "/* Bindings */\n"
               ...
               "/* llvm Functions */\n"
               "\n"
               "::llvm::function ::llvm::void __adjustReferenceCounter(::llvm::i8::pointer, ::llvm::i64);\n"
               "::llvm::function ::llvm::void __adjustReferenceCounterForArrays(::llvm::i8::pointer, ::llvm::i64);\n"
               "::llvm::function ::llvm::void __adjustReferenceCounterForConcreteObjectSafely(::llvm::i8::pointer, ::llvm::i64);\n"
               "::llvm::function ::llvm::void __adjustReferenceCounterForConcreteObjectUnsafely(::llvm::i8::pointer, ::llvm::i64);\n"
               "::llvm::function ::llvm::void __checkArrayIndexFunction(::llvm::i64, ::llvm::i64);\n"
               "::llvm::function ::llvm::void __checkForNullAndThrow(::llvm::i8::pointer);\n"
               "::llvm::function ::llvm::void __destroyOwnerArrayFunction(::llvm::i64::pointer, ::llvm::i64, ::llvm::i1);\n"
               "::llvm::function ::llvm::void __destroyOwnerObjectFunction(::llvm::i8::pointer);\n"
               "::llvm::function ::llvm::void __destroyPrimitiveArrayFunction(::llvm::i64::pointer, ::llvm::i64, ::llvm::i64, ::llvm::i1);\n"
               "::llvm::function ::llvm::void __destroyReferenceArrayFunction(::llvm::i64::pointer, ::llvm::i64, ::llvm::i1);\n"
               "::llvm::function ::llvm::i8::pointer __getOriginalObject(::llvm::i8::pointer);\n"
               "::llvm::function ::llvm::void __throwReferenceCountException(::llvm::i64);\n"
               "::llvm::function ::llvm::i8::pointer produceBridge(::llvm::i8::pointer);\n"
               "::llvm::function ::llvm::void pthread_cancel(::llvm::struct::_opaque_pthread_t::pointer);\n"
               "::llvm::function ::llvm::void pthread_create(::llvm::struct::_opaque_pthread_t::pointer::pointer, ::llvm::struct::_opaque_pthread_attr_t::pointer, ::llvm::i8::pointer (::llvm::i8::pointer)::pointer, ::llvm::i8::pointer);\n"
               "::llvm::function ::llvm::void pthread_exit(::llvm::i8::pointer);\n"
               "::llvm::function ::llvm::void pthread_join(::llvm::struct::_opaque_pthread_t::pointer, ::llvm::i8::pointer::pointer);\n"
               "::llvm::function ::llvm::i32 sleep(::llvm::i32);\n"
               "::llvm::function ::llvm::i8::pointer workBridge(::llvm::i8::pointer);\n"
               "\n"
               "/* llvm Globals */\n"
               "\n"
