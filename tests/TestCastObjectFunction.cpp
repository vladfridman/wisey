...
TEST_F(CastObjectFunctionTest, callTest) {
  ...
  *mStringStream << *mFunction;
  ...
  "\n  store { i8*, i32 } %1, { i8*, i32 }* %2, align 8"
...
TEST_F(CastObjectFunctionTest, getTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  store i8* %toTypeName, i8** %6, align 8"
  ...
  "\n  %15 = call i8* @__cxa_allocate_exception(i64 add (i64 ptrtoint (%wisey.lang.MCastException* getelementptr (%wisey.lang.MCastException, %wisey.lang.MCastException* null, i32 1) to i64), i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64)))"
  "\n  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %15, i8* %14, i64 add (i64 ptrtoint (%wisey.lang.MCastException* getelementptr (%wisey.lang.MCastException, %wisey.lang.MCastException* null, i32 1) to i64), i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64)), i1 false)"
  ...
  "\n          cleanup"
  "\n  %21 = alloca { i8*, i32 }, align 8"
  "\n  br label %cleanup.cont"
  "\n"
  "\ncleanup.cont:                                     ; preds = %cleanup"
  "\n  store { i8*, i32 } %20, { i8*, i32 }* %21, align 8"
