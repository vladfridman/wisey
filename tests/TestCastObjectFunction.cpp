...
TEST_F(CastObjectFunctionTest, getTest) {
  ...
  *mStringStream << *function;
  ...
  "\n          cleanup"
  "\n  %14 = alloca { i8*, i32 }"
  "\n  store { i8*, i32 } %13, { i8*, i32 }* %14"
  "\n  %15 = getelementptr { i8*, i32 }, { i8*, i32 }* %14, i32 0, i32 0"
  "\n  %16 = load i8*, i8** %15"
  "\n  %17 = call i8* @__cxa_get_exception_ptr(i8* %16)"
  "\n  %18 = getelementptr i8, i8* %17, i64 8"
  "\n  %19 = load %wisey.lang.MCastException*, %wisey.lang.MCastException** %4"
  "\n  %20 = bitcast %wisey.lang.MCastException* %19 to i8*"
  "\n  call void @__destroyObjectOwnerFunction(i8* %20, i8* %18)"
  "\n  resume { i8*, i32 } %13"
  "\n"
