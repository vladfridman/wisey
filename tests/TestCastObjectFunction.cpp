...
TEST_F(CastObjectFunctionTest, getTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  %3 = call i8* @__getOriginalObjectName(i8* %fromObjectValue)"
  ...
  "\n  %4 = bitcast %wisey.lang.MCastException.refCounter* %buildervar to i8*"
  "\n  call void @llvm.memset.p0i8.i64(i8* %4, i8 0, i64 ptrtoint (%wisey.lang.MCastException.refCounter* getelementptr (%wisey.lang.MCastException.refCounter, %wisey.lang.MCastException.refCounter* null, i32 1) to i64), i32 4, i1 false)"
  "\n  %5 = getelementptr %wisey.lang.MCastException.refCounter, %wisey.lang.MCastException.refCounter* %buildervar, i32 0, i32 1"
  "\n  %6 = getelementptr %wisey.lang.MCastException, %wisey.lang.MCastException* %5, i32 0, i32 1"
  "\n  store i8* %3, i8** %6"
  "\n  %7 = getelementptr %wisey.lang.MCastException, %wisey.lang.MCastException* %5, i32 0, i32 2"
  "\n  store i8* %toTypeName, i8** %7"
  "\n  %8 = bitcast %wisey.lang.MCastException* %5 to i8*"
  "\n  %9 = getelementptr i8, i8* %8, i64 0"
  "\n  %10 = bitcast i8* %9 to i32 (...)***"
  "\n  %11 = getelementptr { [3 x i8*] }, { [3 x i8*] }* @wisey.lang.MCastException.vtable, i32 0, i32 0, i32 0"
  "\n  %12 = bitcast i8** %11 to i32 (...)**"
  "\n  store i32 (...)** %12, i32 (...)*** %10"
  "\n  %13 = alloca %wisey.lang.MCastException*"
  "\n  store %wisey.lang.MCastException* %5, %wisey.lang.MCastException** %13"
  "\n  %14 = bitcast { i8*, i8* }* @wisey.lang.MCastException.rtti to i8*"
  "\n  %15 = bitcast %wisey.lang.MCastException* %5 to i8*"
  "\n  %16 = getelementptr i8, i8* %15, i64 -8"
  "\n  %17 = call i8* @__cxa_allocate_exception(i64 add (i64 mul nuw (i64 ptrtoint (i1** getelementptr (i1*, i1** null, i32 1) to i64), i64 3), i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64)))"
  "\n  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %17, i8* %16, i64 add (i64 mul nuw (i64 ptrtoint (i1** getelementptr (i1*, i1** null, i32 1) to i64), i64 3), i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64)), i32 4, i1 false)"
  "\n  invoke void @__cxa_throw(i8* %17, i8* %14, i8* null)"
  "\n          to label %invoke.continue unwind label %cleanup"
  "\n"
  ...
  "\n          cleanup"
  "\n  %23 = load %wisey.lang.MCastException*, %wisey.lang.MCastException** %13"
  "\n  %24 = bitcast %wisey.lang.MCastException* %23 to i8*"
  "\n  call void @__destroyObjectOwnerFunction(i8* %24)"
  "\n  resume { i8*, i32 } %22"
  "\n"
