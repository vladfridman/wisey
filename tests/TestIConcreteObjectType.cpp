...
TEST_F(IConcreteObjectTypeTest, composeDestructorForObjectWithObjectOwnerFieldTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  %3 = load %systems.vos.wisey.compiler.tests.MStar*, %systems.vos.wisey.compiler.tests.MStar** %2, align 8"
  ...
  "\n  %refCounter = load i64, i64* %6, align 4"
  ...
  "\n"
  "\ncleanup.cont:                                     ; preds = %cleanup"
  "\n  store { i8*, i32 } %9, { i8*, i32 }* %10, align 8"
...
TEST_F(IConcreteObjectTypeTest, composeDestructorForObjectWithObjectReferenceFieldTest) {
  ...
  *mStringStream << *function;
  ...
  "\n"
  "\ncleanup.cont:                                     ; preds = %cleanup"
  "\n  store { i8*, i32 } %12, { i8*, i32 }* %13, align 8"
...
TEST_F(IConcreteObjectTypeTest, composeDestructorForObjectWithInterfaceOwnerFieldsTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  %3 = load %systems.vos.wisey.compiler.tests.ICanNavigate*, %systems.vos.wisey.compiler.tests.ICanNavigate** %2, align 8"
...
TEST_F(IConcreteObjectTypeTest, composeDestructorBodyNodeObjectTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  %6 = load %wisey.lang.CMemoryPool*, %wisey.lang.CMemoryPool** %5, align 8"
