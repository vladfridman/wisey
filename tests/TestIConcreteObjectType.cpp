...
TEST_F(IConcreteObjectTypeTest, composeDestructorForObjectWithObjectOwnerFieldTest) {
  ...
  *mStringStream << *function;
  ...
  "%systems.vos.wisey.compiler.tests.MGalaxy* %1, i32 0, i32 1"
  ...
  "\n  br i1 %6, label %ref.count.zero, label %ref.count.notzero"
  "\n"
  "\nref.count.zero:                                   ; preds = %if.this.notnull"
  "\n  tail call void @free(i8* %this)"
  "\n  ret void"
...
TEST_F(IConcreteObjectTypeTest, composeDestructorForObjectWithObjectReferenceFieldTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  %2 = getelementptr %systems.vos.wisey.compiler.tests.MConstellation, "
  "%systems.vos.wisey.compiler.tests.MConstellation* %1, i32 0, i32 1"
  "\n  %3 = load %systems.vos.wisey.compiler.tests.MStar*, "
  "%systems.vos.wisey.compiler.tests.MStar** %2"
  "\n  %4 = bitcast %systems.vos.wisey.compiler.tests.MStar* %3 to i64*"
...
TEST_F(IConcreteObjectTypeTest, composeDestructorForObjectWithInterfaceOwnerFieldsTest) {
  ...
  *mStringStream << *function;
  ...
  "%systems.vos.wisey.compiler.tests.MCar* %1, i32 0, i32 1"
