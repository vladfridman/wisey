...
TEST_F(ArrayElementExpressionTest, generateIRTest) {
  ...
  *mStringStream << *mFunction;
  ...
  "\n  %0 = getelementptr i8, ptr null, i64 8"
  "\n  %arraySize = load i64, ptr %0, align 4"
  ...
  "\n  %elementSize = load i64, ptr %8, align 4"
  "\n  %9 = getelementptr i8, ptr null, i64 24"
  "\n  %offset = mul i64 %elementSize, %conv"
  "\n  %10 = getelementptr i8, ptr %9, i64 %offset"
  "\n  %11 = bitcast ptr %10 to ptr"
  "\n  %12 = load i32, ptr %11, align 4"
  "\n"
  "\nnot.in.range:                                     ; preds = %if.not.null"
  "\n  invoke void @__throwArrayIndexException(ptr null, i32 3, i64 %conv, i64 %arraySize)"
