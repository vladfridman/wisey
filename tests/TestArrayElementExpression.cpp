...
TEST_F(ArrayElementExpressionTest, generateIRTest) {
  ...
  *mStringStream << *mFunction;
  ...
  "\n  %arraySize = load i64, i64* %0, align 4"
  "\n  %cmp = icmp sge i64 %conv, %arraySize"
  "\n  %cmp1 = icmp slt i64 %conv, 0"
  "\n  %1 = or i1 %cmp, %cmp1"
  "\n  br i1 %1, label %not.in.range, label %in.range"
  "\n"
  "\ncleanup:                                          ; preds = %not.in.range, %if.null"
  "\n  %2 = landingpad { i8*, i32 }"
  "\n          cleanup"
  ...
  "\n  unreachable"
  "\n"
  "\nin.range:                                         ; preds = %if.not.null"
  "\n  %8 = getelementptr { i64, i64, i64, [0 x i32] }, { i64, i64, i64, [0 x i32] }* null, i64 0, i32 2"
  "\n  %elementSize = load i64, i64* %8, align 4"
  "\n  %9 = getelementptr { i64, i64, i64, [0 x i32] }, { i64, i64, i64, [0 x i32] }* null, i64 0, i32 3"
  "\n  %offset = mul i64 %elementSize, %conv"
  "\n  %10 = bitcast [0 x i32]* %9 to i8*"
  "\n  %11 = getelementptr i8, i8* %10, i64 %offset"
  "\n  %12 = bitcast i8* %11 to i32*"
  "\n  %13 = load i32, i32* %12, align 4"
  "\n"
  "\nnot.in.range:                                     ; preds = %if.not.null"
  "\n  invoke void @__throwArrayIndexException(%wisey.threads.CCallStack* null, i32 3, i64 %conv, i64 %arraySize)"
  "\n          to label %invoke.continue2 unwind label %cleanup"
  "\n"
  "\ninvoke.continue2:                                 ; preds = %not.in.range"
  "\n  unreachable"
  "\n}\n";
...
TEST_F(TestFileRunner, staticArrayElementTest) {
  runFile("tests/samples/test_static_array_element.yz", 5);
}
