...
TEST_F(ArrayElementExpressionTest, generateIRTest) {
  ...
  *mStringStream << *mFunction;
  ...
  "\n  %2 = getelementptr { i64, i64, i64, [0 x i32] }, { i64, i64, i64, [0 x i32] }* null, i64 0, i32 1"
  "\n  %arraySize = load i64, i64* %2"
  ...
  "\n  %3 = getelementptr { i64, i64, i64, [0 x i32] }, { i64, i64, i64, [0 x i32] }* null, i64 0, i32 2"
  "\n  %elementSize = load i64, i64* %3"
  "\n  %4 = getelementptr { i64, i64, i64, [0 x i32] }, { i64, i64, i64, [0 x i32] }* null, i64 0, i32 3"
  "\n  %offset = mul i64 %elementSize, %conv"
  "\n  %5 = bitcast [0 x i32]* %4 to i8*"
  "\n  %6 = getelementptr i8, i8* %5, i64 %offset"
