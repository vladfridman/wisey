...
TEST_F(PoolBuilderTest, generateIRTest) {
  ...
  *mStringStream << *mFunction;
  ...
  "\ndeclare:"
  "\n  %0 = alloca %systems.vos.wisey.compiler.tests.NShape*, align 8"
  "\n  br label %entry"
  "\n"
  "\nentry:                                            ; preds = %declare"
  ...
  "\n  store %wisey.lang.CMemoryPool* null, %wisey.lang.CMemoryPool** %12, align 8"
  ...
  "\n  store %systems.vos.wisey.compiler.tests.NShape* %11, %systems.vos.wisey.compiler.tests.NShape** %0, align 8"
  "\n"
