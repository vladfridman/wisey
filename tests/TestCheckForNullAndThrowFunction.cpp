...
TEST_F(CheckForNullAndThrowFunctionTest, getTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  call void @llvm.memset.p0i8.i64(i8* %0, i8 0, i64 ptrtoint (i64* getelementptr "
  "(i64, i64* null, i32 1) to i64), i32 4, i1 false)"
  ...
  "\n  %4 = call i8* @__cxa_allocate_exception(i64 ptrtoint "
  "(i64* getelementptr (i64, i64* null, i32 1) to i64))"
  "\n  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %4, i8* %2, i64 ptrtoint "
  ...
  "\n  %5 = landingpad { i8*, i32 }"
  "\n          cleanup"
  "\n  %6 = load %wisey.lang.MNullPointerException*, %wisey.lang.MNullPointerException** %1"
  "\n  %7 = bitcast %wisey.lang.MNullPointerException* %6 to i8*"
  "\n  call void @destructor.wisey.lang.MNullPointerException(i8* %7)"
  "\n  resume { i8*, i32 } %5"
  "\n"
