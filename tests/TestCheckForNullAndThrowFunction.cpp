...
TEST_F(CheckForNullAndThrowFunctionTest, getTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  %11 = call i8* @__cxa_allocate_exception(i64 add (i64 ptrtoint (i1** getelementptr (i1*, i1** null, i32 1) to i64), i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64)))"
  "\n  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %11, i8* %10, i64 add (i64 ptrtoint (i1** getelementptr (i1*, i1** null, i32 1) to i64), i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64)), i32 4, i1 false)"
