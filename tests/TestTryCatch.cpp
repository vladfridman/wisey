...
TEST_F(TestFileRunner, tryCatchAccessTryVariableDeathRunTest) {
  expectFailCompile("tests/samples/test_try_catch_access_try_variable.yz",
                    1,
                    "tests/samples/test_try_catch_access_try_variable.yz\\(34\\): Error: Undeclared variable 'a'");
}

TEST_F(TestFileRunner, tryCatchNestedDeathRunTest) {
  expectFailCompile("tests/samples/test_try_catch_nested.yz",
                    1,
                    "tests/samples/test_try_catch_nested.yz\\(44\\): Error: "
...
TEST_F(TestFileRunner, tryCatchWithNpeDeathRunTest) {
  compileAndRunFileCheckOutput("tests/samples/test_try_catch_with_npe.yz",
                               ...
                               "  at systems.vos.wisey.compiler.tests.CThrower.doThrow(tests/samples/test_try_catch_with_npe.yz:23)\n"
                               "  at systems.vos.wisey.compiler.tests.CCatcher.doTryCatch(tests/samples/test_try_catch_with_npe.yz:33)\n"
                               "  at systems.vos.wisey.compiler.tests.CProgram.run(tests/samples/test_try_catch_with_npe.yz:45)\n"
