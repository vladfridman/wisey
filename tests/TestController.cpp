...
TEST_F(ControllerTest, createContextInjectFunctionTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  call void @llvm.memset.p0i8.i64(i8* %20, i8 0, i64 ptrtoint (%systems.vos.wisey.compiler.tests.CSimpleController.refCounter* getelementptr (%systems.vos.wisey.compiler.tests.CSimpleController.refCounter, %systems.vos.wisey.compiler.tests.CSimpleController.refCounter* null, i32 1) to i64), i32 4, i1 false)"
