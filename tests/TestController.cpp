...
TEST_F(ControllerTest, createContextInjectFunctionTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  %2 = bitcast %wisey.threads.IThread* %thread to %wisey.threads.CContextManager* (%wisey.threads.IThread*, %wisey.threads.IThread*, %wisey.threads.CCallStack*)***"
  "\n  %vtable = load %wisey.threads.CContextManager* (%wisey.threads.IThread*, %wisey.threads.IThread*, %wisey.threads.CCallStack*)**, %wisey.threads.CContextManager* (%wisey.threads.IThread*, %wisey.threads.IThread*, %wisey.threads.CCallStack*)*** %2"
  "\n  %3 = getelementptr %wisey.threads.CContextManager* (%wisey.threads.IThread*, %wisey.threads.IThread*, %wisey.threads.CCallStack*)*, %wisey.threads.CContextManager* (%wisey.threads.IThread*, %wisey.threads.IThread*, %wisey.threads.CCallStack*)** %vtable, i64 3"
  "\n  %4 = load %wisey.threads.CContextManager* (%wisey.threads.IThread*, %wisey.threads.IThread*, %wisey.threads.CCallStack*)*, %wisey.threads.CContextManager* (%wisey.threads.IThread*, %wisey.threads.IThread*, %wisey.threads.CCallStack*)** %3"
  "\n  call void @wisey.threads.CCallStack.setLine(%wisey.threads.CCallStack* %callstack, %wisey.threads.IThread* %thread, %wisey.threads.CCallStack* %callstack, i32 0)"
  "\n  %5 = invoke %wisey.threads.CContextManager* %4(%wisey.threads.IThread* %thread, %wisey.threads.IThread* %thread, %wisey.threads.CCallStack* %callstack)"
  "\n          to label %invoke.continue1 unwind label %cleanup"
  "\n"
  "\ninvoke.continue1:                                 ; preds = %invoke.continue"
  "\n  call void @wisey.threads.CCallStack.setLine(%wisey.threads.CCallStack* %callstack, %wisey.threads.IThread* %thread, %wisey.threads.CCallStack* %callstack, i32 0)"
  "\n  %6 = bitcast %wisey.threads.CContextManager* %5 to i8*"
