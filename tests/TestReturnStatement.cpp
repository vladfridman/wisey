...
TEST_F(ReturnStatementTest, ownerVariablesAreClearedTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  call void @__destroyObjectOwnerFunction(i8* %13, %wisey.threads.IThread* null, %wisey.threads.CCallStack* null, i8* %9)"
  "\n  resume { i8*, i32 } %4"
  "\n"
  "\ninvoke.continue:                                  ; preds = %entry"
  "\n  %14 = load %MShape*, %MShape** %pointer"
  "\n  %15 = bitcast %MShape* %14 to i8*"
  "\n  invoke void @__destroyObjectOwnerFunction(i8* %15, %wisey.threads.IThread* null, %wisey.threads.CCallStack* null, i8* null)"
