...
TEST_F(ThrowNullPointerExceptionFunctionTest, callTest) {
  ...
  *mStringStream << *mFunction;
  ...
  "\n  store { i8*, i32 } %0, { i8*, i32 }* %1, align 8"
...
TEST_F(ThrowNullPointerExceptionFunctionTest, getTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  %10 = call i8* @__cxa_allocate_exception(i64 add (i64 ptrtoint (%wisey.lang.MNullPointerException* getelementptr (%wisey.lang.MNullPointerException, %wisey.lang.MNullPointerException* null, i32 1) to i64), i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64)))"
  "\n  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %10, i8* %9, i64 add (i64 ptrtoint (%wisey.lang.MNullPointerException* getelementptr (%wisey.lang.MNullPointerException, %wisey.lang.MNullPointerException* null, i32 1) to i64), i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64)), i1 false)"
