...
struct LLVMPointerOwnerTypeSpecifierTest : public Test {
  ...
  LLVMPointerOwnerTypeSpecifierTest() {
    ...
    LLVMPointerTypeSpecifier* pointerTypeSpecifier = new LLVMPointerTypeSpecifier(i8Specifier);
    mLLVMPointerOwnerTypeSpecifier = new LLVMPointerOwnerTypeSpecifier(pointerTypeSpecifier);
  }
};
