...
TEST_F(CheckArrayIndexFunctionTest, getTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  %7 = landingpad { i8*, i32 }"
  "\n          cleanup"
  "\n  %8 = load %wisey.lang.MArrayIndexOutOfBoundsException*, %wisey.lang.MArrayIndexOutOfBoundsException** %2"
  "\n  %9 = bitcast %wisey.lang.MArrayIndexOutOfBoundsException* %8 to i8*"
  "\n  call void @__destroyObjectOwnerFunction(i8* %9)"
  "\n  resume { i8*, i32 } %7"
  "\n"
