...
TEST_F(DestroyReferenceArrayFunctionTest, getTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  %size = load i64, i64* %0, align 4"
  "\n  %1 = getelementptr i64, i64* %arrayPointer, i64 2"
  "\n  %elementSize = load i64, i64* %1, align 4"
  "\n  %dimensionsMinusOne = sub i64 %noOfDimensions, 1"
  "\n  %refCount = load i64, i64* %arrayPointer, align 4"
  ...
  "\n  store i64 0, i64* %indexStore, align 4"
  "\n  store i64 0, i64* %offsetStore, align 4"
  "\n  br label %for.cond"
  "\n"
  ...
  "\n  %offset = load i64, i64* %offsetStore, align 4"
  "\n  %index = load i64, i64* %indexStore, align 4"
  ...
  "\n  store i64 %newIndex, i64* %indexStore, align 4"
  "\n  %offsetIncrement = add i64 %offset, %elementSize"
  "\n  store i64 %offsetIncrement, i64* %offsetStore, align 4"
  ...
  "\n  store { i8*, i32 } %10, { i8*, i32 }* %11, align 8"
  ...
  "\n  %18 = atomicrmw add i64* %17, i64 -1 monotonic, align 8"
  "\n  br label %if.end"
  "\n}\n";
