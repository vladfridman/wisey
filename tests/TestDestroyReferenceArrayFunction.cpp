...
TEST_F(DestroyReferenceArrayFunctionTest, callTest) {
  ...
  *mStringStream << *mBasicBlock;
  string expected =
  "\nentry:"
  "\n  %0 = call i64 @__destroyReferenceArrayFunction(i64* null, i64 2, i1 true)\n";
...
TEST_F(DestroyReferenceArrayFunctionTest, getTest) {
  ...
  *mStringStream << *function;
  string expected =
  "\ndefine internal i64 @__destroyReferenceArrayFunction(i64* %arrayPointer, i64 %noOfDimensions, i1 %shouldFree) personality i32 (...)* @__gxx_personality_v0 {"
  "\nentry:"
  ...
  "\n  %5 = call i64 @__destroyReferenceArrayFunction(i64* %4, i64 %dimensionsMinusOne, i1 false)"
  ...
  "\n  %6 = load i8*, i8** %3"
  "\n  call void @__adjustReferenceCounterForConcreteObjectSafely(i8* %6, i64 -1)"
