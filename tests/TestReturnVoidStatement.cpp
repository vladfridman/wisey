...
TEST_F(ReturnVoidStatementTest, ownerVariablesAreClearedTest) {
  ...
  *mStringStream << *function;
  ...
  "\ndeclare:"
  "\n  %pointer = alloca %MShape*, align 8"
  "\n  %pointer2 = alloca %MShape*, align 8"
  "\n  br label %entry"
  "\n"
  "\nentry:                                            ; preds = %declare"
  ...
  "\n  store %MShape* %0, %MShape** %pointer, align 8"
  ...
  "\n  store %MShape* %1, %MShape** %pointer2, align 8"
  "\n  %2 = load %MShape*, %MShape** %pointer2, align 8"
  ...
  "\n  %10 = load %MShape*, %MShape** %pointer2, align 8"
  ...
  "\n  %12 = load %MShape*, %MShape** %pointer, align 8"
  ...
  "\n  %14 = load %MShape*, %MShape** %pointer, align 8"
...
TEST_F(ReturnVoidStatementTest, referenceVariablesGetTheirRefCountDecrementedTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  %13 = atomicrmw add i64* %12, i64 -1 monotonic, align 8"
  "\n  br label %if.end2"
  "\n}\n";
  ASSERT_STREQ(expected.c_str(), mStringStream->str().c_str());
}
