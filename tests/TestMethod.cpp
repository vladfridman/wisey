...
TEST_F(MethodTest, definePublicFunctionTest) {
  ...
  *mStringStream << *function;
  string expected = "declare float @systems.vos.wisey.compiler.tests.MObject.method.foo(ptr, ptr, ptr, i32)"
  "\n";
...
TEST_F(MethodTest, definePrivateFunctionTest) {
  ...
  *mStringStream << *function;
  string expected = "declare internal float @systems.vos.wisey.compiler.tests.MObject.method.foo(ptr, ptr, ptr, i32)"
  "\n";
  EXPECT_STREQ(expected.c_str(), mStringStream->str().c_str());
}
...
TEST_F(MethodTest, generateIRTest) {
  ...
  *mStringStream << *function;
  string expected =
  "define void @systems.vos.wisey.compiler.tests.MObject.method.foo(ptr %this, ptr %thread, ptr %callstack, i32 %intargument) {"
  "\ndeclarations:"
  "\n  br label %entry"
  "\n"
