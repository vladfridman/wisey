...
TEST_F(DestroyOwnerArrayFunctionTest, callTest) {
  ...
  DestroyOwnerArrayFunction::call(mContext, arrayPointer, 2u, arrayNamePointer);
  
  *mStringStream << *mBasicBlock;
  string expected =
  "\nentry:"
  "\n  call void @__destroyOwnerArrayFunction(i64* null, i64 2, i8* null, i1 true)\n";
...
TEST_F(DestroyOwnerArrayFunctionTest, getTest) {
  ...
  *mStringStream << *function;
  string expected =
  "\ndefine void @__destroyOwnerArrayFunction(i64* %arrayPointer, i64 %noOfDimensions, i8* %arrayName, i1 %shouldFree) personality i32 (...)* @__gxx_personality_v0 {"
  "\nentry:"
  ...
  "\n  call void @__destroyOwnerArrayFunction(i64* %5, i64 %dimensionsMinusOne, i8* %arrayName, i1 false)"
  "\n  br label %for.cond"
  "\n"
