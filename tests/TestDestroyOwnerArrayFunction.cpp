...
TEST_F(DestroyOwnerArrayFunctionTest, getTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  %1 = load i64, i64* %arrayPointer"
  "\n  %2 = icmp eq i64 %1, 0"
  "\n  br i1 %2, label %ref.count.zero, label %ref.count.notzero"
  "\n"
  "\nref.count.zero:                                   ; preds = %if.not.null"
  "\n  %3 = getelementptr i64, i64* %arrayPointer, i64 1"
  "\n  %dimensions = load i64, i64* %3"
  "\n  %offset = add i64 %dimensions, 2"
  "\n  %4 = getelementptr i64, i64* %arrayPointer, i64 2"
  "\n  %size = load i64, i64* %4"
  "\n  %5 = getelementptr i64, i64* %3, i64 %offset"
  ...
  "\n  invoke void @__throwReferenceCountException(i64 %1)"
