...
TEST_F(AdjustReferenceCounterForInterfaceFunctionTest, getTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  %5 = bitcast i8* %object to i8*"
  "\n  %6 = call i8* @__getOriginalObject(i8* %5, i64 0)"
  "\n  %7 = bitcast i8* %6 to i8***"
  "\n  %vtable = load i8**, i8*** %7"
  "\n  %8 = getelementptr i8*, i8** %vtable, i64 1"
  "\n  %typeArrayI8 = load i8*, i8** %8"
  "\n  %9 = bitcast i8* %typeArrayI8 to i8**"
  "\n  %10 = getelementptr i8*, i8** %9, i64 0"
  "\n  %stringPointer = load i8*, i8** %10"
  "\n  %firstLetter = load i8, i8* %stringPointer"
  "\n  %11 = icmp eq i8 %firstLetter, 77"
  "\n  br i1 %11, label %if.model, label %if.not.model"
  "\n"
  "\nif.model:                                         ; preds = %if.notnull"
  "\n  %12 = atomicrmw add i64* %4, i64 %adjustment monotonic"
  "\n  ret void"
  "\n"
  "\nif.not.model:                                     ; preds = %if.notnull"
  "\n  %count = load i64, i64* %4"
  "\n  %13 = add i64 %count, %adjustment"
  "\n  store i64 %13, i64* %4"
  "\n  ret void"
  "\n}\n";
