...
TEST_F(ObjectAllocatorTest, generateIRTest) {
  ...
  *mStringStream << *mFunction;
  ...
  "\n  %6 = bitcast %wisey.lang.CMemoryPool* null to i8*"
  "\n  invoke void @__checkForNullAndThrow(i8* %6)"
  "\n          to label %invoke.continue unwind label %cleanup"
  "\n"
  "\nif.apr.pool.notnull:                              ; preds = %entry"
  "\n  %7 = getelementptr %CMemoryPool, %CMemoryPool* %2, i32 0, i32 1"
  "\n  %8 = load i64, i64* %7"
  "\n  %9 = add i64 %8, 1"
  "\n  store i64 %9, i64* %7"
  "\n  %call = invoke i8* @wisey.lang.CMemoryPool.pallocate(%wisey.threads.IThread* null, %wisey.threads.CCallStack* null, %AprPool* %4, i64 ptrtoint (%systems.vos.wisey.compiler.tests.MShape.refCounter* getelementptr (%systems.vos.wisey.compiler.tests.MShape.refCounter, %systems.vos.wisey.compiler.tests.MShape.refCounter* null, i32 1) to i64))"
  "\n          to label %invoke.continue2 unwind label %cleanup"
  "\n"
  "\nif.apr.pool.end:                                  ; preds = %invoke.continue2, %invoke.continue1"
  "\n  %10 = load i8*, i8** %0"
  "\n  %11 = bitcast i8* %10 to %systems.vos.wisey.compiler.tests.MShape.refCounter*"
  "\n  %12 = getelementptr %systems.vos.wisey.compiler.tests.MShape.refCounter, %systems.vos.wisey.compiler.tests.MShape.refCounter* %11, i32 0, i32 0"
  "\n  store i64 0, i64* %12"
  "\n  %13 = getelementptr %systems.vos.wisey.compiler.tests.MShape.refCounter, %systems.vos.wisey.compiler.tests.MShape.refCounter* %11, i32 0, i32 1"
  "\n  %14 = getelementptr %systems.vos.wisey.compiler.tests.MShape, %systems.vos.wisey.compiler.tests.MShape* %13, i32 0, i32 1"
  "\n  store %wisey.lang.CMemoryPool* null, %wisey.lang.CMemoryPool** %14"
  "\n  %15 = getelementptr %systems.vos.wisey.compiler.tests.MShape, %systems.vos.wisey.compiler.tests.MShape* %13, i32 0, i32 2"
  "\n  store i32 3, i32* %15"
  "\n  %16 = getelementptr %systems.vos.wisey.compiler.tests.MShape, %systems.vos.wisey.compiler.tests.MShape* %13, i32 0, i32 3"
  "\n  store i32 5, i32* %16"
  "\n  %17 = bitcast %systems.vos.wisey.compiler.tests.MShape* %13 to i8*"
  "\n  %18 = getelementptr i8, i8* %17, i64 0"
  "\n  %19 = bitcast i8* %18 to i32 (...)***"
  "\n  %20 = getelementptr { [3 x i8*] }, { [3 x i8*] }* @systems.vos.wisey.compiler.tests.MShape.vtable, i32 0, i32 0, i32 0"
  "\n  %21 = bitcast i8** %20 to i32 (...)**"
  "\n  store i32 (...)** %21, i32 (...)*** %19"
  "\n  store %systems.vos.wisey.compiler.tests.MShape* %13, %systems.vos.wisey.compiler.tests.MShape** %1"
  "\n"
  "\ncleanup:                                          ; preds = %if.apr.pool.notnull, %invoke.continue, %if.apr.pool.null"
  ...
  "\n  resume { i8*, i32 } %22"
  "\n"
  "\ninvoke.continue:                                  ; preds = %if.apr.pool.null"
  "\n  %28 = invoke i8* @wisey.lang.CMemoryPool.allocate(%wisey.lang.CMemoryPool* null, %wisey.threads.IThread* null, %wisey.threads.CCallStack* null, i64 ptrtoint (%systems.vos.wisey.compiler.tests.MShape.refCounter* getelementptr (%systems.vos.wisey.compiler.tests.MShape.refCounter, %systems.vos.wisey.compiler.tests.MShape.refCounter* null, i32 1) to i64))"
  ...
  "\n"
  "\ninvoke.continue2:                                 ; preds = %if.apr.pool.notnull"
  "\n  store i8* %call, i8** %0"
  "\n  br label %if.apr.pool.end"
  "\n}"
  "\n";
