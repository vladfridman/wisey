...
TEST_F(ObjectAllocatorTest, generateIRTest) {
  ...
  *mStringStream << *mFunction;
  ...
  "\n  %21 = invoke i8* @wisey.lang.CMemoryPool.allocate(%wisey.lang.CMemoryPool* null, %wisey.threads.IThread* null, %wisey.threads.CCallStack* null, i64 ptrtoint (%systems.vos.wisey.compiler.tests.MShape.refCounter* getelementptr (%systems.vos.wisey.compiler.tests.MShape.refCounter, %systems.vos.wisey.compiler.tests.MShape.refCounter* null, i32 1) to i64))"
  "\n          to label %invoke.continue1 unwind label %cleanup"
  "\n"
  "\ncleanup:                                          ; preds = %if.apr.pool.notnull, %if.not.null, %if.null"
