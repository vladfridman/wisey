...
TEST_F(AdjustReferenceCounterForConcreteObjectUnsafelyFunctionTest, callTest) {
  ...
  AdjustReferenceCounterForConcreteObjectUnsafelyFunction::call(mContext, nullPointerValue, 1, 0);
...
TEST_F(AdjustReferenceCounterForConcreteObjectUnsafelyFunctionTest, getTest) {
  ...
  *mStringStream << *function;
  string expected =
  "\ndefine void @__adjustReferenceCounterForConcreteObjectUnsafely(i8* %object, i64 %adjustment) {"
  "\nentry:"
