...
TEST_F(ThrowStatementTest, modelExpressionTypeTest) {
  ...
  *mStringStream << *mFunction;
  ...
  "\n  %3 = call i8* @__cxa_allocate_exception(i64 add (i64 ptrtoint (%systems.vos.wisey.compiler.tests.MCircle* getelementptr (%systems.vos.wisey.compiler.tests.MCircle, %systems.vos.wisey.compiler.tests.MCircle* null, i32 1) to i64), i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64)))"
  "\n  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %3, i8* %2, i64 add (i64 ptrtoint (%systems.vos.wisey.compiler.tests.MCircle* getelementptr (%systems.vos.wisey.compiler.tests.MCircle, %systems.vos.wisey.compiler.tests.MCircle* null, i32 1) to i64), i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64)), i1 false)"
...
TEST_F(ThrowStatementTest, ownerVariablesAreClearedTest) {
  ...
  *mStringStream << *mFunction;
  ...
  "define internal i32 @main() personality i32 (...)* @__gxx_personality_v0 {"
  "\ndeclare:"
  "\n  %pointer = alloca %systems.vos.wisey.compiler.tests.MCircle*, align 8"
  "\n  %pointer2 = alloca %systems.vos.wisey.compiler.tests.MCircle*, align 8"
  "\n  br label %entry"
  "\n"
  "\nentry:                                            ; preds = %declare"
  "\n  %malloccall = tail call i8* @malloc(i64 ptrtoint (%systems.vos.wisey.compiler.tests.MCircle* getelementptr (%systems.vos.wisey.compiler.tests.MCircle, %systems.vos.wisey.compiler.tests.MCircle* null, i32 1) to i64))"
  "\n  %0 = bitcast i8* %malloccall to %systems.vos.wisey.compiler.tests.MCircle*"
  "\n  store %systems.vos.wisey.compiler.tests.MCircle* %0, %systems.vos.wisey.compiler.tests.MCircle** %pointer, align 8"
  "\n  %malloccall1 = tail call i8* @malloc(i64 ptrtoint (%systems.vos.wisey.compiler.tests.MCircle* getelementptr (%systems.vos.wisey.compiler.tests.MCircle, %systems.vos.wisey.compiler.tests.MCircle* null, i32 1) to i64))"
  "\n  %1 = bitcast i8* %malloccall1 to %systems.vos.wisey.compiler.tests.MCircle*"
  "\n  store %systems.vos.wisey.compiler.tests.MCircle* %1, %systems.vos.wisey.compiler.tests.MCircle** %pointer2, align 8"
  ...
  "\n  %5 = call i8* @__cxa_allocate_exception(i64 add (i64 ptrtoint (%systems.vos.wisey.compiler.tests.MCircle* getelementptr (%systems.vos.wisey.compiler.tests.MCircle, %systems.vos.wisey.compiler.tests.MCircle* null, i32 1) to i64), i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64)))"
  "\n  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %5, i8* %4, i64 add (i64 ptrtoint (%systems.vos.wisey.compiler.tests.MCircle* getelementptr (%systems.vos.wisey.compiler.tests.MCircle, %systems.vos.wisey.compiler.tests.MCircle* null, i32 1) to i64), i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64)), i1 false)"
  ...
  "\n  %12 = load %systems.vos.wisey.compiler.tests.MCircle*, %systems.vos.wisey.compiler.tests.MCircle** %pointer2, align 8"
  ...
  "\n  %14 = load %systems.vos.wisey.compiler.tests.MCircle*, %systems.vos.wisey.compiler.tests.MCircle** %pointer, align 8"
...
TEST_F(ThrowStatementTest, referenceVariablesGetTheirRefCountDecrementedTest) {
  ...
  *mStringStream << *mFunction;
  ...
  "define internal i32 @main() personality i32 (...)* @__gxx_personality_v0 {"
  "\ndeclare:"
  "\n  %0 = alloca %MModel*, align 8"
  "\n  %1 = alloca %MModel*, align 8"
  "\n  br label %entry"
  "\n"
  "\nentry:                                            ; preds = %declare"
  ...
  "\n  store %MModel* %2, %MModel** %0, align 8"
  ...
  "\n  store %MModel* %3, %MModel** %1, align 8"
  ...
  "\n  %7 = call i8* @__cxa_allocate_exception(i64 add (i64 ptrtoint (%systems.vos.wisey.compiler.tests.MCircle* getelementptr (%systems.vos.wisey.compiler.tests.MCircle, %systems.vos.wisey.compiler.tests.MCircle* null, i32 1) to i64), i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64)))"
  "\n  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %7, i8* %6, i64 add (i64 ptrtoint (%systems.vos.wisey.compiler.tests.MCircle* getelementptr (%systems.vos.wisey.compiler.tests.MCircle, %systems.vos.wisey.compiler.tests.MCircle* null, i32 1) to i64), i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64)), i1 false)"
  ...
  "\n  %20 = atomicrmw add i64* %19, i64 -1 monotonic, align 8"
  "\n  br label %if.end"
  "\n"
  ...
  "\n  %23 = atomicrmw add i64* %22, i64 -1 monotonic, align 8"
  "\n  br label %if.end2"
  "\n"
  "\ninvoke.continue:                                  ; preds = %entry"
  "\n  unreachable"
