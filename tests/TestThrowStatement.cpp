...
TEST_F(ThrowStatementTest, modelExpressionTypeTest) {
  ...
  *mStringStream << *mFunction;
  ...
  "\n  %2 = call i8* @__cxa_allocate_exception(i64 0)"
  "\n  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* %0, i64 0, i32 4, i1 false)"
  "\n  invoke void @__cxa_throw(i8* %2, i8* %1, i8* null)"
...
TEST_F(ThrowStatementTest, ownerVariablesAreClearedTest) {
  ...
  *mStringStream << *mFunction;
  ...
  "\n  %4 = call i8* @__cxa_allocate_exception(i64 0)"
  "\n  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %4, i8* %2, i64 0, i32 4, i1 false)"
  "\n  invoke void @__cxa_throw(i8* %4, i8* %3, i8* null)"
  "\n          to label %invoke.continue unwind label %cleanup"
  "\n"
  "\ncleanup:                                          ; preds = %entry"
  "\n  %5 = landingpad { i8*, i32 }"
  "\n          cleanup"
  "\n  %6 = load %systems.vos.wisey.compiler.tests.MCircle*, "
  "%systems.vos.wisey.compiler.tests.MCircle** %pointer2"
  "\n  %7 = bitcast %systems.vos.wisey.compiler.tests.MCircle* %6 to i8*"
  "\n  call void @destructor.systems.vos.wisey.compiler.tests.MCircle(i8* %7)"
  "\n  %8 = load %systems.vos.wisey.compiler.tests.MCircle*, "
  "%systems.vos.wisey.compiler.tests.MCircle** %pointer"
  "\n  %9 = bitcast %systems.vos.wisey.compiler.tests.MCircle* %8 to i8*"
  "\n  call void @destructor.systems.vos.wisey.compiler.tests.MCircle(i8* %9)"
  "\n  resume { i8*, i32 } %5"
  "\n"
  "\ninvoke.continue:                                  ; preds = %entry"
  "\n  unreachable"
...
TEST_F(ThrowStatementTest, referenceVariablesGetTheirRefCountDecrementedTest) {
  ...
  *mStringStream << *mFunction;
  ...
  "\n  %6 = call i8* @__cxa_allocate_exception(i64 0)"
  "\n  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %6, i8* %4, i64 0, i32 4, i1 false)"
  "\n  invoke void @__cxa_throw(i8* %6, i8* %5, i8* null)"
  "\n          to label %invoke.continue unwind label %cleanup"
  "\n"
  "\ncleanup:                                          ; preds = %entry"
  "\n  %7 = landingpad { i8*, i32 }"
  "\n          cleanup"
  "\n  %8 = load %MModel*, %MModel** %3"
  "\n  %9 = bitcast %MModel* %8 to i8*"
  "\n  call void @__adjustReferenceCounterForConcreteObjectSafely(i8* %9, i64 -1)"
  "\n  %10 = load %MModel*, %MModel** %1"
  "\n  %11 = bitcast %MModel* %10 to i8*"
  "\n  call void @__adjustReferenceCounterForConcreteObjectSafely(i8* %11, i64 -1)"
  "\n  resume { i8*, i32 } %7"
  "\n"
  "\ninvoke.continue:                                  ; preds = %entry"
  "\n  unreachable"
