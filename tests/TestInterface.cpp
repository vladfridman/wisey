...
TEST_F(InterfaceTest, injectWrapperFunctionTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  call void @llvm.memset.p0i8.i64(i8* %2, i8 0, i64 ptrtoint (%wisey.lang.MInterfaceNotBoundException.refCounter* getelementptr (%wisey.lang.MInterfaceNotBoundException.refCounter, %wisey.lang.MInterfaceNotBoundException.refCounter* null, i32 1) to i64), i32 4, i1 false)"
  ...
  "\n  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %13, i8* %12, i64 add (i64 mul nuw (i64 ptrtoint (i1** getelementptr (i1*, i1** null, i32 1) to i64), i64 2), i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64)), i32 4, i1 false)"
