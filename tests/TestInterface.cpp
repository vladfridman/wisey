...
TEST_F(InterfaceTest, injectWrapperFunctionTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  %9 = landingpad { i8*, i32 }"
  "\n          cleanup"
  "\n  %10 = load %wisey.lang.MInterfaceNotBoundException*, %wisey.lang.MInterfaceNotBoundException** %3"
  "\n  %11 = bitcast %wisey.lang.MInterfaceNotBoundException* %10 to i8*"
  "\n  call void @__destroyObjectOwnerFunction(i8* %11)"
  "\n  resume { i8*, i32 } %9"
  "\n"
