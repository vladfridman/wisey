...
TEST_F(InterfaceTest, injectWrapperFunctionTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  %3 = bitcast { i8*, i8* }* @wisey.lang.MInterfaceNotBoundException.rtti to i8*"
  "\n  %4 = bitcast %wisey.lang.MInterfaceNotBoundException* %2 to i8*"
  "\n  %5 = getelementptr i8, i8* %4, i64 -8"
  "\n  %6 = call i8* @__cxa_allocate_exception(i64 add (i64 mul nuw (i64 ptrtoint (i1** getelementptr (i1*, i1** null, i32 1) to i64), i64 2), i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64)))"
  "\n  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %6, i8* %5, i64 add (i64 mul nuw (i64 ptrtoint (i1** getelementptr (i1*, i1** null, i32 1) to i64), i64 2), i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64)), i32 4, i1 false)"
  "\n  tail call void @free(i8* %5)"
  "\n  invoke void @__cxa_throw(i8* %6, i8* %3, i8* null)"
  "\n          to label %invoke.continue unwind label %cleanup"
  "\n"
  "\nif.not.null:                                      ; preds = %entry"
  "\n  %7 = call %systems.vos.wisey.compiler.tests.IShape* %0(%wisey.threads.IThread* %thread, %wisey.threads.CCallStack* %callstack)"
  "\n  ret %systems.vos.wisey.compiler.tests.IShape* %7"
  "\n"
