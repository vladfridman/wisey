...
TEST_F(InterfaceTest, injectWrapperFunctionTest) {
  ...
  *mStringStream << *function;
  ...
  "\n"
  "\nif.null:                                          ; preds = %entry"
  "\n  %2 = call %wisey.lang.MInterfaceNotBoundException* @wisey.lang.MInterfaceNotBoundException.build(i8* getelementptr inbounds ([40 x i8], [40 x i8]* @systems.vos.wisey.compiler.tests.IShape.typename, i32 0, i32 0))"
  "\n  %3 = alloca %wisey.lang.MInterfaceNotBoundException*"
  "\n  store %wisey.lang.MInterfaceNotBoundException* %2, %wisey.lang.MInterfaceNotBoundException** %3"
  "\n  %4 = bitcast { i8*, i8* }* @wisey.lang.MInterfaceNotBoundException.rtti to i8*"
  "\n  %5 = bitcast %wisey.lang.MInterfaceNotBoundException* %2 to i8*"
  "\n  %6 = getelementptr i8, i8* %5, i64 -8"
  "\n  %7 = call i8* @__cxa_allocate_exception(i64 add (i64 mul nuw (i64 ptrtoint (i1** getelementptr (i1*, i1** null, i32 1) to i64), i64 2), i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64)))"
  "\n  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %7, i8* %6, i64 add (i64 mul nuw (i64 ptrtoint (i1** getelementptr (i1*, i1** null, i32 1) to i64), i64 2), i64 ptrtoint (i64* getelementptr (i64, i64* null, i32 1) to i64)), i32 4, i1 false)"
  "\n  invoke void @__cxa_throw(i8* %7, i8* %4, i8* null)"
  "\n          to label %invoke.continue unwind label %cleanup"
  "\n"
  "\nif.not.null:                                      ; preds = %entry"
  "\n  %8 = call %systems.vos.wisey.compiler.tests.IShape* %0(%wisey.threads.IThread* %thread, %wisey.threads.CCallStack* %callstack)"
  "\n  ret %systems.vos.wisey.compiler.tests.IShape* %8"
  "\n"
  ...
  "\n  %15 = load %wisey.lang.MInterfaceNotBoundException*, %wisey.lang.MInterfaceNotBoundException** %3"
  "\n  %16 = bitcast %wisey.lang.MInterfaceNotBoundException* %15 to i8*"
  "\n  call void @__destroyObjectOwnerFunction(i8* %16, i8* %14)"
  "\n  resume { i8*, i32 } %9"
  "\n"
