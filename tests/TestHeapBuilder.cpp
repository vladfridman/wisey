...
TEST_F(HeapBuilderTest, generateIRTest) {
  ...
  *mStringStream << *mFunction;
  ...
  "\n"
  "\nentry:                                            ; preds = %declare"
  "\n  %buildervar = tail call ptr @malloc(i64 ptrtoint (ptr getelementptr (%systems.vos.wisey.compiler.tests.MShape.refCounter, ptr null, i32 1) to i64))"
  "\n  %1 = bitcast ptr %buildervar to ptr"
  "\n  call void @llvm.memset.p0.i64(ptr %1, i8 0, i64 ptrtoint (ptr getelementptr (%systems.vos.wisey.compiler.tests.MShape.refCounter, ptr null, i32 1) to i64), i1 false)"
  "\n  %2 = getelementptr %systems.vos.wisey.compiler.tests.MShape.refCounter, ptr %buildervar, i32 0, i32 1"
  "\n  %3 = getelementptr %systems.vos.wisey.compiler.tests.MShape, ptr %2, i32 0, i32 1"
  "\n  store i32 3, ptr %3, align 4"
  "\n  %4 = getelementptr %systems.vos.wisey.compiler.tests.MShape, ptr %2, i32 0, i32 2"
  "\n  store i32 5, ptr %4, align 4"
  "\n  %5 = bitcast ptr %2 to ptr"
  "\n  %6 = getelementptr i8, ptr %5, i64 0"
  "\n  %7 = bitcast ptr %6 to ptr"
  "\n  %8 = getelementptr { [3 x ptr] }, ptr @systems.vos.wisey.compiler.tests.MShape.vtable, i32 0, i32 0, i32 0"
