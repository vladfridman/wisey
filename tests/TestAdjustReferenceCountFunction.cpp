...
TEST_F(AdjustReferenceCountFunctionTest, getTest) {
  ...
  *mStringStream << *function;
  ...
  "\n  br i1 %8, label %safe, label %not.model"
  "\n"
  "\nsafe:                                             ; preds = %not.model, %if.notnull"
  "\n  %9 = atomicrmw add i64* %4, i64 %adjustment monotonic"
  "\n  ret void"
  "\n"
  "\nunsafe:                                           ; preds = %not.model"
  "\n  %count = load i64, i64* %4"
  "\n  %10 = add i64 %count, %adjustment"
  "\n  store i64 %10, i64* %4"
  "\n  ret void"
  "\n"
  "\nnot.model:                                        ; preds = %if.notnull"
  "\n  %11 = icmp eq i8 %firstLetter, 84"
  "\n  br i1 %11, label %safe, label %unsafe"
  "\n}\n";
